...
Suppose, we want to compare values of two arrays or objects. Do we compare as we do in primitive types?&#x20;

:::info
We do sometimes when arrays or objects are copied, see example below
:::

Never! We compare through each index or property. So, having the same value doesn’t mean that comparison is the same. 
